...
void ssd1306_printText(uint8_t x, uint8_t y,const char *ptString) {
    ...
    while (*ptString != '\0') {
        ...
        i2c_write(SSD1306_I2C_ADDRESS, buf, 1);
...
void ssd1306_printTextBlock(uint8_t x, uint8_t y, const char *ptString) {
    char word[12];
