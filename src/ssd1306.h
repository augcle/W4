...
extern unsigned char buffer[17];                                                     // buffer for data transmission to screen
...
#define SSD1306_I2C_ADDRESS             0x3C// 0x78 //0x3C
...
void ssd1306_printText(uint8_t, uint8_t,const char *);
void ssd1306_printTextBlock(uint8_t, uint8_t,const char *);
